...
|---------|-------------|------------|
| [Sales Analysis][View Code](https://github.com/alizay-k/data-analyst-roadmap/blob/main/data-analyst-roadmap/week1_sql/practice.py) | GROUP BY/HAVING practice with sales data | SQLite, Python |
| More coming soon... | | |
